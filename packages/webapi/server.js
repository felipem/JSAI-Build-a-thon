...
const pdfPath = path.join(projectRoot, 'data/data.pdf');
  ...
  const systemMessage = useRAG
    ? {
        ...
        content: sources.length > 0
          ? `You are a helpful assistant for summarizing information from AESO Rule 021. You must ONLY use the information provided below to answer.\n\n--- AESO RULE 021 DOCUMENT EXCERPTS ---\n${sources.join('\n\n')}\n--- END OF EXCERPTS ---`
          : `You are a helpful assistant for summarizing information from AESO Rule 021. The excerpts do not contain relevant information for this question. Reply politely: \"I'm sorry, I don't know. The AESO Rule 021 does not contain information about that.\"`,
      }
    : {
        role: "system",
